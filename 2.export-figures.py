...
def main():
    ...
    data_folder = Path(__file__).parent / "test-data"
    input_doc_path = data_folder / "PUC_MP 40-40.pdf"
    if not input_doc_path.exists():
        raise FileNotFoundError(
            f"Source PDF not found: {input_doc_path}. Place the file there or update the path."
        )
